...
'''
    Analysis Plot 3 -> Relationship between Employment Type and Keywords
'''
...
df = df[(df.employmentType != "Volunteer") & (df.employmentType != "Other")]

sns.barplot(y="employmentType", x="independenceRatio", data=df, estimator=np.mean)
plt.title("Relationship between Employment Type and Independence Keywords")
plt.show()