...
sns.barplot(y="seniorityLevel", x="dependenceRatio", data=df, estimator=np.mean, order=["Internship", "Entry level", "Associate", "Mid-Senior level", "Director"])
plt.title("Relationship between Seniority Levels and Dependence Keywords")
plt.show()